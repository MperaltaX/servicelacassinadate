...
class DateTimePickerDtt extends StatefulWidget {
  @override
  _DateTimePickerState createState() => _DateTimePickerState();
}

class _DateTimePickerState extends State<DateTimePickerDtt> {
  late double _height;
  late double _width;
  ...
  Future<Null> _selectDate(BuildContext context) async {
    ...
    if (picked != null)
      setState(() {
        ...
        selectedDateF = selectedDate.add(Duration(days: 205)); // fecha exacta
        selectedDateMin = selectedDate.add(Duration(days: 160)); // fecha minima
        selectedDateMax = selectedDate.add(Duration(days: 250)); // fecha maxima

        _textNacFinal.text = 'Destete Exacto día: ' +
      ...
      body: Container(
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage("assets/imgScreen2.png"),
            fit: BoxFit.cover,
          ),
        ),
        width: _width,
