...
class DateTimePickerNac extends StatefulWidget {
  @override
  _DateTimePickerState createState() => _DateTimePickerState();
}

class _DateTimePickerState extends State<DateTimePickerNac> {
  late double _height;
  late double _width;
  ...
  Future<Null> _selectDate(BuildContext context) async {
    ...
    if (picked != null)
      setState(() {
        ...
        selectedDateF =
            selectedDate.subtract(Duration(days: 270)); // fecha exacta
        selectedDateMin =
            selectedDate.subtract(Duration(days: 275)); // fecha minima
        selectedDateMax =
            selectedDate.subtract(Duration(days: 265)); // fecha maxima

        _textNacFinal.text = 'Servicio Exacto día: ' +
      ...
      body: Container(
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage("assets/imgScreen1.png"),
            fit: BoxFit.cover,
          ),
        ),
        width: _width,
