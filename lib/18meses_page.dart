...
class DateTimePickerMes extends StatefulWidget {
  @override
  _DateTimePickerState createState() => _DateTimePickerState();
}

class _DateTimePickerState extends State<DateTimePickerMes> {
  late double _height;
  late double _width;
  ...
  Future<Null> _selectDate(BuildContext context) async {
    ...
    if (picked != null)
      setState(() {
        ...
        selectedDateF = selectedDate.add(Duration(days: 550)); // fecha exacta
        selectedDateMin = selectedDate.add(Duration(days: 505)); // fecha minima
        selectedDateMax = selectedDate.add(Duration(days: 595)); // fecha maxima

        _textNacFinal.text = '18 Meses Exacto día: ' +
